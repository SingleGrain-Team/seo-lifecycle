...
// Remove any prior seed script, then inject a fresh one right before </head>.
let out = src.replace(/<script id="seed-data">[\s\S]*?<\/script>/g, "");
out = out.replace("</head>", seedTag + "\n</head>");
